      ...
      <div className="max-w-7xl mx-auto px-6 py-10 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <a href="/bot-setup" className="bg-white p-6 rounded-2xl border border-gray-100 hover:border-gray-300 hover:shadow-lg transition-all duration-300 flex items-center gap-4 group">
            <a href="/dashboard/products" className="bg-white p-6 rounded-2xl border border-gray-100 hover:border-orange-300 hover:shadow-lg transition-all duration-300 flex items-center gap-4 group">
            <div className="w-14 h-14 bg-orange-50 rounded-xl flex items-center justify-center text-2xl group-hover:scale-110 transition-transform duration-300"></div>
            <div><h3 className="font-bold text-gray-900 text-lg">Manage Price List</h3><p className="text-sm text-gray-500">Set item prices for auto-calculation</p></div>
          </a>
