  ...
  return (
    <div className="min-h-screen bg-gray-50/50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10 space-y-8">
        ...
        {/* 4. Mini Revenue Chart (Last 7 Days) */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <a href="/dashboard/orders" className="bg-white p-6 rounded-2xl border border-gray-100 hover:border-blue-300 hover:shadow-lg transition-all duration-300 flex items-center gap-4 group">
            ...
            <div>
              <h3 className="font-bold text-gray-900 text-lg">Manage Orders</h3>
              <p className="text-sm text-gray-500">View, confirm or reject all orders</p>
            </div>
          </a>
          <a href="/analytics" className="bg-white p-6 rounded-2xl border border-gray-100 hover:border-indigo-300 hover:shadow-lg transition-all duration-300 flex items-center gap-4 group">
            <div className="w-14 h-14 bg-indigo-50 rounded-xl flex items-center justify-center text-2xl group-hover:scale-110 transition-transform duration-300">
              📊
            </div>
            <div>
              <h3 className="font-bold text-gray-900 text-lg">View Analytics</h3>
              <p className="text-sm text-gray-500">Detailed sales charts and insights</p>
            </div>
          </a>
