    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {!isPaid ? (
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-2xl p-6 mb-8 flex flex-col md:flex-row justify-between items-center gap-4 shadow-sm">
            <div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          {orders.length === 0 ? (
            <div className="p-12 text-center text-gray-500">
              ...
              <p className="text-sm">Send a test order from your Telegram bot to see it here!</p>
            </div>
          ) : (
